...
const VOICE_LOCAL_API_PROXY_SCHEMA_TABLES: readonly VoiceLocalApiProxySchemaTableDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "artifact_index", sqlite: "INTEGER NOT NULL DEFAULT 0", postgresql: "INTEGER NOT NULL DEFAULT 0" },
  ...
  {
    name: "vlap_artifact_drive_sync",
    columns: [
      { name: "sync_id", sqlite: "TEXT PRIMARY KEY", postgresql: "TEXT PRIMARY KEY" },
      { name: "task_id", sqlite: "TEXT NOT NULL", postgresql: "TEXT NOT NULL" },
      { name: "artifact_id", sqlite: "TEXT NOT NULL", postgresql: "TEXT NOT NULL" },
      { name: "artifact_index", sqlite: "INTEGER NOT NULL DEFAULT 0", postgresql: "INTEGER NOT NULL DEFAULT 0" },
      { name: "actor_type", sqlite: "TEXT NOT NULL", postgresql: "TEXT NOT NULL" },
      { name: "user_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "anonymous_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "drive_space_type", sqlite: "TEXT NOT NULL", postgresql: "TEXT NOT NULL" },
      { name: "drive_space_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "drive_node_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "drive_upload_item_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "drive_upload_session_id", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "drive_resource_json", ...jsonColumn("TEXT", "JSONB") },
      { name: "source_uri", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "sync_status", sqlite: "TEXT NOT NULL", postgresql: "TEXT NOT NULL" },
      { name: "error_summary", sqlite: "TEXT", postgresql: "TEXT" },
      { name: "created_at_ms", sqlite: "INTEGER NOT NULL", postgresql: "BIGINT NOT NULL" },
      { name: "updated_at_ms", sqlite: "INTEGER NOT NULL", postgresql: "BIGINT NOT NULL" },
    ],
    indexes: [
      { name: "idx_vlap_artifact_drive_sync_task", columns: "task_id, artifact_index" },
      { name: "idx_vlap_artifact_drive_sync_status", columns: "sync_status, updated_at_ms DESC" },
    ],
  },
  {
