...
- hosted provider output, such as Suno track URLs or Volcengine/Kling/Jimeng-style generated media arrays, is represented as `external_url` or `provider_asset`
