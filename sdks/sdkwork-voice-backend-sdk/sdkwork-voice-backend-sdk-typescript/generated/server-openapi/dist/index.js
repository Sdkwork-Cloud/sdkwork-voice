...
class VoiceProviderRoutesApi {
    ...
    async list(params) {
        ...
        return this.client.get(appendQueryString(backendApiPath(`/voice/provider_routes`), query));
    }
    /** Provider Routes create. */
    async create(body) {
        return this.client.post(backendApiPath(`/voice/provider_routes`), body, undefined, undefined, 'application/json');
    }
    /** Provider Routes delete. */
    async delete(providerRouteId) {
        return this.client.delete(backendApiPath(`/voice/provider_routes/${serializePathParameter(providerRouteId, { name: 'providerRouteId', style: 'simple', explode: false })}`));
    }
    /** Provider Routes retrieve. */
    async retrieve(providerRouteId) {
        return this.client.get(backendApiPath(`/voice/provider_routes/${serializePathParameter(providerRouteId, { name: 'providerRouteId', style: 'simple', explode: false })}`));
    }
    /** Provider Routes update. */
    async update(providerRouteId, body) {
        return this.client.patch(backendApiPath(`/voice/provider_routes/${serializePathParameter(providerRouteId, { name: 'providerRouteId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
    }
}
class VoiceAudioArtifactsApi {
    constructor(client) {
        this.client = client;
    }
    ...
    async list(params) {
        ...
        return this.client.get(appendQueryString(backendApiPath(`/voice/audio_artifacts`), query));
    }
    /** Audio Artifacts delete. */
    async delete(audioArtifactId) {
        return this.client.delete(backendApiPath(`/voice/audio_artifacts/${serializePathParameter(audioArtifactId, { name: 'audioArtifactId', style: 'simple', explode: false })}`));
    }
    /** Audio Artifacts retrieve. */
    async retrieve(audioArtifactId) {
...
export { BaseApi, HttpClient, SdkworkBackendClient, VoiceApi, backendApiPath, createClient, createHttpClient, createVoiceApi };
