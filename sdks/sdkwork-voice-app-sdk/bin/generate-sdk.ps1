...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/voice-app-sdk" }
        "dart" { return "sdkwork_voice_app_sdk" }
        "flutter" { return "sdkwork_voice_app_sdk" }
        "python" { return "sdkwork-voice-app-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-voice-app-sdk" }
        "java" { return "com.sdkwork:sdkwork-voice-app-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-voice-app-sdk" }
        "swift" { return "sdkwork-voice-app-sdk" }
        "csharp" { return "SDKWork.Voice.AppSdk" }
        "rust" { return "sdkwork-voice-app-sdk" }
        "php" { return "sdkwork/voice-app-sdk" }
        "ruby" { return "sdkwork-voice-app-sdk" }
        default { return "sdkwork-voice-app-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.voice.app.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.voice.app.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Voice.AppSdk") }
        "php" { return @("--namespace", "SDKWork\Voice\AppSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-voice-app-api.sdkgen.yaml"
$SdkName = "sdkwork-voice-app-sdk"
