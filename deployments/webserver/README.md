...
Module `sdkwork-voice` · runtime code `voice` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `voice-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `voice-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `voice-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `voice-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `voice.sdkwork.com` | 443 ssl + 80 |
