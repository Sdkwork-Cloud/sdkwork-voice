...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `voice-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `voice-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `voice-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `voice-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `voice.sdkwork.com` | 443 ssl + 80 |
