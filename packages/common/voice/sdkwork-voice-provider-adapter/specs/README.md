...
This directory is the local SDKWork component contract for `@sdkwork/voice-provider-adapter`.

- Component root: `sdkwork-voice/packages/common/voice/sdkwork-voice-provider-adapter`
