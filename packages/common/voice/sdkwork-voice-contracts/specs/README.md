...
This directory is the local SDKWork component contract for `@sdkwork/voice-contracts`.

- Component root: `sdkwork-voice/packages/common/voice/sdkwork-voice-contracts`
