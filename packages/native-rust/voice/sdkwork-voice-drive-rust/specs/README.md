...
This directory is the local SDKWork component contract for `sdkwork-voice-drive-rust`.

- Component root: `sdkwork-voice/packages/native-rust/voice/sdkwork-voice-drive-rust`
