...
This directory is the local SDKWork component contract for `sdkwork-voice-storage-sqlx-rust`.

- Component root: `sdkwork-voice/packages/native-rust/voice/sdkwork-voice-storage-sqlx-rust`
