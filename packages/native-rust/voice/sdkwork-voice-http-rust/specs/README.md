...
This directory is the local SDKWork component contract for `sdkwork-voice-http-rust`.

- Component root: `sdkwork-voice/packages/native-rust/voice/sdkwork-voice-http-rust`
