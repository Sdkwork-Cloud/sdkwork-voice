...
This directory is the local SDKWork component contract for `sdkwork-voice-local-api-proxy-native`.

- Component root: `sdkwork-voice/packages/native-rust/voice/sdkwork-voice-local-api-proxy-native`
