# sdkwork-voice Source Configuration
...
| `appId` | `sdkwork-voice` |
| `runtimeCode` | `voice` |
| Config root | `/etc/sdkwork/voice/` |
| Runtime TOML | `/etc/sdkwork/voice/config.toml` |
| Secrets | `/etc/sdkwork/voice/secrets/` |
| Override | `SDKWORK_VOICE_CONFIG_FILE` |
